      ...
      {isLogoutModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 backdrop-blur-sm">
          <div className="bg-white p-6 rounded-2xl max-w-sm w-full mx-4 border border-gray-150 shadow-2xl space-y-4">
            ...
            <p className="text-xs font-semibold text-gray-500">Are you sure you want to end your active session and log out of the payroll portal?</p>
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-xs font-bold transition-all cursor-pointer shadow-md shadow-rose-600/10"
              >
                Yes, Logout
              </button>
            </div>
